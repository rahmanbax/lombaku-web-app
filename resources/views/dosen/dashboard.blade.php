...
<body class="bg-gray-100">
    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-gray-800 text-white p-4">
            ...
            <nav>
                {{-- ========================================================== --}}
                {{-- === PERUBAHAN DI SINI: route('dosen') -> route('dosen.dashboard') === --}}
                {{-- ========================================================== --}}
                ...
                {{-- Menambahkan link Riwayat agar konsisten --}}
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="bg-white shadow-md p-4 flex justify-between items-center border-b">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @endauth
                    @guest
                        <a href="{{ route('login') }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium rounded-md">Login</a>
                    @endguest
                </div>
            </header>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p id="kpi-mahasiswa-aktif" class="text-2xl font-bold text-gray-900">...</p>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-500">Total Lomba Diikuti</p>
                                    <p id="kpi-lomba-diikuti" class="text-2xl font-bold text-gray-900">...</p>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white p-6 rounded-lg shadow-md">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p id="kpi-menunggu-persetujuan" class="text-2xl font-bold text-gray-900">...</p>
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- Bagian Tabel Daftar Bimbingan -->
                    <div class="bg-white rounded-lg shadow-md">
                        <div class="p-6 border-b border-gray-200">
                            <h2 class="text-xl font-semibold text-gray-800">Daftar Bimbingan Lomba Terbaru</h2>
                        </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status Persetujuan</th>
                                    </tr>
                                </thead>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function fetchDashboardData(url = API_BASE_URL) {
                ...
                try {
                    const response = await axios.get(url, { headers: { 'Authorization': `Bearer ${localStorage.getItem('authToken')}` } });
                    ...
                    if (error.response && (error.response.status === 401 || error.response.status === 403)) {
                        errorMessage = "Otentikasi Gagal. Anda tidak memiliki izin untuk mengakses data ini. Silakan login kembali.";
                    }
