...
<head>
    ...
    <style>
        ...
        .ts-control { padding: 0.60rem 0.75rem !important; border-radius: 0.5rem !important; border-color: #d1d5db !important; }
        .ts-control:focus { border-color: #3B82F6 !important; box-shadow: 0 0 0 2px rgba(59, 130, 246, 0.5) !important; }
    </style>
</head>
                ...
                <div class="space-y-6 mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="peringkat" name="peringkat" class="mt-1 w-full p-3 border rounded-lg form-input" placeholder="Contoh: Juara 1" required>
                            <p class="error-message"></p>
                        </div>
                    </div>
                    <div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const memberSelect = new TomSelect('#member_ids', {
        ...
        load: function(query, callback) {
            ...
            axios.get('/api/mahasiswa/search', { params: { q: query } })
